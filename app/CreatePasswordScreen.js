...
import { encryptPassword, storeEncryptedData } from "../api/securityService";
...
export default function CreatePasswordScreen() {
  ...
  const storePasswordSecurely = async (password) => {
    try {
      ...
      const encryptedPasswordData = await encryptPassword(password);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity onPress={handleContinue} style={styles.button} disabled={isCreating}>
          {isCreating ? (
